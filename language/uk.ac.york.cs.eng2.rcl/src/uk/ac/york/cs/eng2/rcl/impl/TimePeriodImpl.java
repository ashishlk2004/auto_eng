 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.york.cs.eng2.rcl.impl.TimePeriodImpl#getValue <em>Value</em>}</li>
 *   <li>{@link uk.ac.york.cs.eng2.rcl.impl.TimePeriodImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimePeriodImpl extends MinimalEObjectImpl.Container implements TimePeriod {
	...
	protected EClass eStaticClass() {
		return RclPackage.Literals.TIME_PERIOD;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RclPackage.TIME_PERIOD__VALUE, oldValue, value));
	}
	...
	public void setUnit(TimeUnit newUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RclPackage.TIME_PERIOD__UNIT, oldUnit, unit));
	}
