...
public class RclSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RclPackage.COMPONENT: {
				Component component = (Component)theEObject;
				T result = caseComponent(component);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RclPackage.TOPIC: {
				Topic topic = (Topic)theEObject;
				T result = caseTopic(topic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RclPackage.SLOT: {
				Slot slot = (Slot)theEObject;
				T result = caseSlot(slot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RclPackage.TRIGGER: {
				Trigger trigger = (Trigger)theEObject;
				T result = caseTrigger(trigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RclPackage.TIME_TRIGGER: {
			...
			case RclPackage.TOPIC_TRIGGER: {
				TopicTrigger topicTrigger = (TopicTrigger)theEObject;
				T result = caseTopicTrigger(topicTrigger);
				if (result == null) result = caseTrigger(topicTrigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RclPackage.TIME_PERIOD: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Topic Trigger</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Topic Trigger</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTopicTrigger(TopicTrigger object) {
		return null;
	}
