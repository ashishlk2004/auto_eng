...
/**
 * This is the item provider adapter for a {@link uk.ac.york.cs.eng2.rcl.Slot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SlotItemProvider 
	...
	protected void addPartPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Slot_part_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Slot_part_feature", "_UI_Slot_type"),
				 RclPackage.Literals.SLOT__PART,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Slot.class)) {
			case RclPackage.SLOT__NAME:
			case RclPackage.SLOT__TYPE:
			case RclPackage.SLOT__PART:
